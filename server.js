...
(function() {
  var MailParser, ad, createServer, db, host, levelup, port, readFile, readFileSync, request, server, writeFile, _ref, _ref1;

  _ref = require('http'), createServer = _ref.createServer, request = _ref.request;

  _ref1 = require('fs'), readFileSync = _ref1.readFileSync, writeFile = _ref1.writeFile, readFile = _ref1.readFile;
  ...
  server = createServer(function(req, res) {
    ...
    if (req.url === '/') {
      ...
      mailparser.on('end', function(mail) {
        ...
        return writeFile('./public/' + id, html, function(err) {
          if (err == null) {
      ...
      return readFile('./public' + req.url, function(err, data) {
        if (err != null) {
